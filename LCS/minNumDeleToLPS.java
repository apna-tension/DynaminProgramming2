...
// Q: Minimum number of character deletion require to make a string palindrome
public class minNumDeleToLPS {
    public static void main(String[] args) {
        String s1 = "greaege";
        String s2 = new StringBuilder(s1).reverse().toString();
        int n = s1.length();
        int m = s2.length();
        System.out.println("The minimum number of character deletion require to make a string palindrome is : "
                + (n - tabulation(s1, s2, n, m)));
    }

    // write the tabulation method
