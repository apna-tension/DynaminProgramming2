...
public class scramble_String_Memoize {
    ...
    // write the memoize solve method
    private static boolean solve(String s1, String s2, boolean[][] dp) {
        ...
        for (int i = 1; i < n; i++) {
            ...
            boolean cond1 = (solve(s1.substring(0, i), s2.substring(n - i, n), dp)
                    && solve(s1.substring(i, n), s2.substring(0, n - i), dp));
