// Q: Given two strings s1 and s2 of the same length, determine if s2 is a scrambled string of s1.
        // - A scrambled string is a string that is formed by taking a substring of s1 and
        //   appending it at any position in s1.
        // - For example, "abcde" is a scrambled string of "aebcd" because you can take
        //   substring "ae" and append it at position 1 to get "aebcd".
...
public class scramble_String {
    public static void main(String[] args) {
        String s1 = "great";
        String s2 = "rgeat"; // In this string s2 if we split it into two parts - "rg" and "eat" then we can swap the "rg" to "gr" and get the string s1
    ...
    private static boolean solve(String s1, String s2) {
        ...
        // if the two strings are not equal then we need to check if the two strings are scrambled or not
        int n = s1.length();
        boolean flag = false;
        for (int i = 1; i < n; i++) {
            // if we swap the two parts of the string and check if the two strings are equal or not
            ...
            // if we don't swap the two parts of the string and check if the two strings are equal or not
            ...
            // if any of the above two conditions are true then we can say that the string is scrambled
            if (cond1 || cond2) {
                flag = true;
                break;
            }
